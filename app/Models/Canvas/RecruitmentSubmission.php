...
class RecruitmentSubmission extends Model implements HasMedia
{
     ...
     * @var string
     */
    protected $table = 'website_rec_subs';
    ...
    /**
     * Get the academic relationship.
     *
     * @return BelongsTo
     */
    public function academic()
    {
        return $this->belongsTo(AcademicCategory::class, 'acad_id');
    }

    /**
     * Get the publication relationship.
     *
     * @return BelongsTo
     */
    public function publication()
    {
        return $this->belongsTo(RecruitmentPublication::class, 'pub_id');
    }
