...
class ShortCourseRegistration extends Model implements HasMedia
{
     ...
     * @var string
     */
    protected $table = 'website_scourse_enrolments';
    ...
    {
        return $this->belongsTo(ShortCourseClass::class, 'class_id');
    }
