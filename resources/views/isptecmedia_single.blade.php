    ...
    @if($related_posts->count() > 0)
        ...
        <article class="col-sm-4 ">
            <div class="card p-1  shadow-none">
                <div class="p-3">
                    <h5><a href="{!! route('aci.showisptecmedia', [$related->slug . '?lang=' . (session()->get('locale') ?? 'pt') . '&id=' . $related->id]) !!}" class="text-dark">{!! $related->title !!}</a></h5>
                ...
                <div class="p-3">
                    ...
                    <div>
                        <a href="{!! route('aci.showisptecmedia', [$related->slug . '?lang=' . (session()->get('locale') ?? 'pt') . '&id=' . $related->id]) !!}" class="text-primary btn btn-sm btn-primary btn-rounded text-light">
