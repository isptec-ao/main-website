    ...
    export default {
        ...
        data () {
          return {
            ...
            title: this.$page.props.page.title,
            code: this.$page.props.page.code,
            description: this.$page.props.page.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.pages.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
              window.open(route('canvas.pages.downloadallattachments') + '?model_id=' + this.$page.props.page.id);
          },

          downloadSingleAttachment (id) {
              window.open(route('canvas.pages.downloadsingleattachment') + '?model_id=' + id);
          },
          deleteSingleAttachment (id) {
              window.open(route('canvas.pages.deletesingleattachment') + '?model_id=' + id);
          }, 
        },
        computed: {
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Pages Form -->
            <b-form @submit.prevent="form.post(route('canvas.pages.settranslation', $page.props.page.id))">
              <slot />
