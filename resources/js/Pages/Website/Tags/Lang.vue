<script>
    ...
    export default {
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.tags.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.tags.index')" method="get">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Tags Form -->
            <b-form @submit.prevent="form.put(route('canvas.tags.settranslation', $page.props.tag.id))">
              <slot />
