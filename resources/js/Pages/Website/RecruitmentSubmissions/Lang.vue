<script>
    ...
    export default {
        name: "LangRecruitmentSubmission",
        layout: (h, dashboard) => h(BaseCanvasLayout, {
            props: {
              errors: Object,
              recruitmentsubmission: Object,
              lang: String,
            }
        }, [dashboard]),
        ...
        data () {
          return {
            ...
            pub_id: this.$page.props.recruitmentsubmission.publication,
            acad_id: this.$page.props.recruitmentsubmission.academic,
            full_name: this.$page.props.recruitmentsubmission.full_name,
            gender: this.$page.props.recruitmentsubmission.gender,
            id_no: this.$page.props.recruitmentsubmission.id_no,
            naturality: this.$page.props.recruitmentsubmission.naturality,
            dob: this.$page.props.recruitmentsubmission.dob,
            email: this.$page.props.recruitmentsubmission.email,
            tel_no: this.$page.props.recruitmentsubmission.tel_no,
            country: this.$page.props.recruitmentsubmission.country,
            marital_status: this.$page.props.recruitmentsubmission.marital_status,
            address: this.$page.props.recruitmentsubmission.address,
            suburb: this.$page.props.recruitmentsubmission.suburb,
            postal_code: this.$page.props.recruitmentsubmission.postal_code,
            work_experience: this.$page.props.recruitmentsubmission.work_experience,
            other_info: this.$page.props.recruitmentsubmission.other_info,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.recruitmentsubmissions.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.recruitmentsubmissions.downloadallattachments') + '?model_id=' + this.$page.props.recruitmentsubmission.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.recruitmentsubmissions.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.recruitmentsubmissions.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.recruitmentsubmissions.settranslation', $page.props.recruitmentsubmission.id))">
              <slot />
        ...
        <div class="card">
          ...
          <table class="table table-centered table-hover" v-if="$page.props.documents">
                <tbody>
                    ...
                    <td>
                      <div class="text-center">
                        <a href="javascript: void(0);" class="text-dark">
                          <i class="bx bx-download h6 text-success m-0" @click="downloadSingleAttachment(document.id)"></i>
                        </a>
                        <a href="javascript: void(0);" class="text-dark">
                  ...
                  <td colspan="2">
                    <div class="text-center">
                      <a class="btn btn-rounded btn-brand" @click="downloadAllAttachments()">Baixar Documentação</a>
                    </div>
                  </td>
                  </tr>
                </tbody>
