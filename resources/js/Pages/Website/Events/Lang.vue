    ...
    export default {
        ...
        data () {
          return {
            ...
            title: this.$page.props.event.title,
            description: this.$page.props.event.description,
            venue: this.$page.props.event.venue,
            start_date: this.$page.props.event.start_date,
            end_date: this.$page.props.event.end_date,
            start_time: this.$page.props.event.start_time,
            end_time: this.$page.props.event.end_time,
            color: this.$page.props.event.color,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.events.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.events.downloadallattachments') + '?model_id=' + this.$page.props.event.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.events.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.events.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.events.index')" method="get">
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.events.settranslation', $page.props.event.id))">
              <slot />
              <b-form-group label="Cor" label-for="color">
              <b-input id="color"
                            name="color"
                            type="color"
                            v-model="form.color"
              ...
              <div v-if="form.errors.color" class="invalid-feedback animated fadeIn">{{form.errors.color}}</div>
              </b-form-group>
            ...
            <b-form-group label="Data - In´cio" label-for="start_date">
