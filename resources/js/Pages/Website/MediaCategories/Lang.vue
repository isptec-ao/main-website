    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.mediacategory.name,
            description: this.$page.props.mediacategory.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.mediacategories.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.mediacategories.index')" method="get">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create ISPTEC na Mídia - Categorias Form -->
            <b-form @submit.prevent="form.put(route('canvas.mediacategories.settranslation', $page.props.mediacategory.id))">
              <slot />
