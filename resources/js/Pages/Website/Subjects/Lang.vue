    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.subject.name,
            description: this.$page.props.subject.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.subjects.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.subjects.index')" method="get">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.put(route('canvas.subjects.settranslation', $page.props.subject.id))">
              <slot />
