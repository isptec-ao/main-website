    ...
    export default {
        ...
        data () {
          return {
            ...
            category_id: this.$page.props.partnership.category,
            name: this.$page.props.partnership.name,
            link: this.$page.props.partnership.link,
            description: this.$page.props.partnership.description,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.partnerships.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.partnerships.downloadallattachments') + '?model_id=' + this.$page.props.partnership.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.partnerships.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.partnerships.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.partnerships.index')" method="get">
    ...
    <div class="row">
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.partnerships.settranslation', $page.props.partnership.id))">
              <slot />
            ...
            <b-form-group label="Link" label-for="link">
                <b-form-input id="link" type="url" v-model="form.link" :class="{'is-invalid': form.errors.link}"></b-form-input>
      ...
      <div class="col-lg-5">
        <div class="card">
          ...
          <b-form-group>
          <table class="table table-centered table-hover" v-if="$page.props.documents.length">
                <tbody>
