        ...
        watch: {
          form: {
            handler: throttle(function() {
              ...
              this.$inertia.replace(this.route('canvas.isptecmedia.index', Object.keys(query).length ? query : { remember: 'forget' }))
            }, 150),
            deep: true,
          },
        },
        methods: {
          destroy(id) {
            if(confirm('tem a certeza?')) {
              this.$inertia.delete(this.route('canvas.isptecmedia.delete', id));
            }
          },
          restore(id) {
            if(confirm('tem a certeza?')) {
              this.$inertia.put(this.route('canvas.isptecmedia.restore', id));
            }
          },
          setTrans(id, lang) {
            
              this.$inertia.get(this.route('canvas.isptecmedia.getlang', {isptecmedia: id, lang: lang}));
          },
          reset() {
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0 font-size-18">ISPTEC na Mídia</h4>
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                <b-button v-b-modal.action-info variant="secondary">
                    <i class="bx bx-info-circle"></i>
                </b-button>
                <inertia-link class="btn btn-secondary" :href="route('canvas.isptecmedia.create')" method="get">
            ...
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  ...
                  <h4 class="mb-0">{{ $page.props.draftCount + $page.props.publishedCount }}</h4>
                </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
                  ...
                  <b-input-group class="">
                      ...
                      <b-input-group-append>
                          <b-dropdown right size="sm" class="">
                              ...
                              <b-dropdown-item class="font-size-sm" @click="form.type='draft'">Drafts </b-dropdown-item>
                              <b-dropdown-item class="font-size-sm" @click="form.type='published'">Published </b-dropdown-item>
                  ...
                  <tr v-for="post in $page.props.posts.data" :key="post.id">
                    ...
                    <td>
                      <b-button-group class="btn-group-sm mt-0">
                          <inertia-link class="btn btn-secondary" :href="route('canvas.isptecmedia.edit', post.id)" method="get">
                              <i class="bx bx-pencil align-middle"></i>
                          </inertia-link>
                          <b-button variant="secondary" @click="destroy(post.id)">
                              <i class="bx bx-trash align-middle"></i>
                          </b-button>
                          <b-button variant="secondary" @click="restore(post.id)">
            ...
            <pagination :links="$page.props.posts.links" :lastpage="$page.props.posts.last_page" :firstpageurl="$page.props.posts.first_page_url" :lastpageurl="$page.props.posts.last_page_url" :nextpageurl="$page.props.posts.next_page_url" />
          </div>
        </div>
      </div>
      <!-- end col -->
