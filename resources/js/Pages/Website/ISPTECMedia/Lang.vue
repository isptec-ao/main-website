    ...
    export default {
        ...
        data () {
          return {
            ...
            documents: null,
            categories: this.$page.props.post.categories,
            _method: 'PUT'
          }),
          editor: InlineEditor,
                editorConf: {
        ...
        methods: {
            settranslation(id) {
              this.$inertia.post(this.route('canvas.isptecmedia.settranslation', id));
          },
          downloadAllAttachments () {
                window.open(route('canvas.isptecmedia.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.isptecmedia.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.isptecmedia.deletesingleattachment') + '?model_id=' + id);
            },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.isptecmedia.index')" method="get">
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Posts Form -->
            <b-form @submit.prevent="form.post(route('canvas.isptecmedia.settranslation', $page.props.post.id))">
              <slot />
              ...
              <b-form-group label="Etiquetas" label-for="categories">
              <multiselect
                  id="ajax"
