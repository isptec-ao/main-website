    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.filecategory.name,
            description: this.$page.props.filecategory.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.filecategories.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.filecategories.index')" method="get">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Ficheiros - Categorias Form -->
            <b-form @submit.prevent="form.put(route('canvas.filecategories.settranslation', $page.props.filecategory.id))">
              <slot />
