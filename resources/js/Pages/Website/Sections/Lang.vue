    ...
    export default {
        ...
        data () {
          return {
            ...
            page_id: this.$page.props.section.page,
            title: this.$page.props.section.title,
            description: this.$page.props.section.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.sections.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.sections.index')" method="get">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Pages Form -->
            <b-form @submit.prevent="form.put(route('canvas.sections.settranslation', $page.props.section.id))">
              <slot />
              <b-form-group label="Page" label-for="page_id">
              <multiselect
                  id="ajax"
