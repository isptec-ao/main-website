    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.semester.name,
            year: this.$page.props.semester.year,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.semesters.settranslation', id));
          },
        },
        computed: {
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.put(route('canvas.semesters.settranslation', $page.props.semester.id))">
              <slot />
