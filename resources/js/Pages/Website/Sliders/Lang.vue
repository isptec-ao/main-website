    ...
    export default {
        ...
        data () {
          return {
            ...
            page_id: this.$page.props.slider.page,
            title: this.$page.props.slider.title,
            description: this.$page.props.slider.description,
            width: this.$page.props.slider.width,
            height: this.$page.props.slider.height,
            lang: this.$page.props.lang,
            images: this.$page.props.images,
            _method: 'PUT'
          })
        }
        },
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.sliders.settranslation', id));
            },
            addImage() {
            ...
            downloadSingleAttachment (id) {
                window.open(route('canvas.sliders.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.sliders.deletesingleattachment') + '?model_id=' + id);
            },
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.sliders.settranslation', $page.props.slider.id))">
              <slot />
        ...
        <div class="card">
          ...
          <div class="m-2" v-for="(image, index) in form.images" :key="index">
            ...
            <b-form-group label="Pre-visualização" :label-for="'imagepreview_' + index">
              <div class="col-md-5">
                  <img class="rounded" :src="(image.id ? image.image_url : image.imagepreview)" alt="" width="200">
              </div>
            </b-form-group>
