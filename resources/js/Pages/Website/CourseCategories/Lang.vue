    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.coursecategory.name,
            description: this.$page.props.coursecategory.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.coursecategories.settranslation', id));
          },
        },
        computed: {
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Cursos - Categorias Form -->
            <b-form @submit.prevent="form.put(route('canvas.coursecategories.settranslation', $page.props.coursecategory.id))">
              <slot />
