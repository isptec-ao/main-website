    ...
    export default {
        ...
        data () {
          return {
            ...
            employee_id: this.$page.props.celcategory.employee,
            responsible_name: this.$page.props.celcategory.responsible_name,
            name: this.$page.props.celcategory.name,
            description: this.$page.props.celcategory.description,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.celcategories.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.celcategories.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.celcategories.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.celcategories.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0 font-size-18">Clube</h4>
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.celcategories.index')" method="get">
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.celcategories.settranslation', $page.props.celcategory.id))">
              <slot />
             <b-form-group label="Responsável" label-for="employee_id">
              <multiselect
                  id="ajax"
              ...
              <div v-if="form.errors.employee_id" class="invalid-feedback animated fadeIn">{{form.errors.employee_id}}</div>
              </b-form-group>
              <b-form-group label="Responsavel Externo (caso nao for funcionario)" label-for="responsible_name">
                <b-form-input id="responsible_name" type="text" v-model="form.responsible_name" :class="{'is-invalid': form.errors.responsible_name}"></b-form-input>
                <div v-if="form.errors.responsible_name" class="invalid-feedback animated fadeIn">{{form.errors.responsible_name}}</div>
              </b-form-group>
