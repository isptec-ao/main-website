<script>
    ...
    export default {
        name: "LangRecruitmentCategory",
        layout: (h, dashboard) => h(BaseCanvasLayout, {
            props: {
              errors: Object,
              recruitmentcategory: Object,
              lang: String,
            }
        }, [dashboard]),
        ...
        data () {
          return {
            ...
            name: this.$page.props.recruitmentcategory.name,
            description: this.$page.props.recruitmentcategory.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.recruitmentcategories.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.recruitmentcategories.index')" method="get">
