    ...
    export default {
        ...
        data () {
          return {
            ...
            name: this.$page.props.course.name,
            description: this.$page.props.course.description,
            duration: this.$page.props.course.duration,
            start_date: this.$page.props.course.start_date,
            category_id: this.$page.props.course.category,
            department_id: this.$page.props.course.department,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.courses.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.courses.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.courses.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.courses.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.courses.settranslation', $page.props.course.id))">
              <slot />
