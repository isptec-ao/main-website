<script>
    ...
    export default {
        name: "LangAcademicCategory",
        layout: (h, dashboard) => h(BaseCanvasLayout, {
            props: {
              errors: Object,
              academiccategory: Object,
              lang: String,
            }
        }, [dashboard]),
        ...
        data () {
          return {
            ...
            name: this.$page.props.academiccategory.name,
            description: this.$page.props.academiccategory.description,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.academiccategories.settranslation', id));
          },
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.academiccategories.index')" method="get">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Graus Académicos Form -->
            <b-form @submit.prevent="form.put(route('canvas.academiccategories.settranslation', $page.props.academiccategory.id))">
              <slot />
