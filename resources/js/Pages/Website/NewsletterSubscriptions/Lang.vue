<script>
    ...
    export default {
        name: "LangNewsletterSubscription",
        layout: (h, dashboard) => h(BaseCanvasLayout, {
            props: {
              errors: Object,
              newslettersubscription: Object,
              lang: String,
            }
        }, [dashboard]),
        ...
        data () {
          return {
            ...
            fullname: this.$page.props.newslettersubscription.fullname,
            email: this.$page.props.newslettersubscription.email,
            category_id: this.$page.props.newslettersubscription.category,
            status: this.$page.props.newslettersubscription.status,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.newslettersubscriptions.settranslation', id));
          },
        },
        computed: {
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Create Newsletter - Inscrições Form -->
            <b-form @submit.prevent="form.put(route('canvas.newslettersubscriptions.settranslation', $page.props.newslettersubscription.id))">
              <slot />
