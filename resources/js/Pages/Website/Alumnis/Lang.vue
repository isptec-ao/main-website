    ...
    export default {
        ...
        data () {
          return {
            ...
            course_id: this.$page.props.alumni.course,
            student_full_name: this.$page.props.alumni.student_full_name,
            year: this.$page.props.alumni.year,
            summary: this.$page.props.alumni.summary,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.alumnis.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.alumnis.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.alumnis.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.alumnis.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.alumnis.settranslation', $page.props.alumni.id))">
              <slot />
