<script>
    ...
    export default {
        name: "LangRecruitmentPublication",
        layout: (h, dashboard) => h(BaseCanvasLayout, {
            props: {
              errors: Object,
              recruitmentpublication: Object,
              lang: String,
            }
        }, [dashboard]),
        ...
        data () {
          return {
            ...
            title: this.$page.props.recruitmentpublication.title,
            description: this.$page.props.recruitmentpublication.description,
            requirements: this.$page.props.recruitmentpublication.requirements,
            start_date: this.$page.props.recruitmentpublication.start_date,
            end_date: this.$page.props.recruitmentpublication.end_date,
            start_time: this.$page.props.recruitmentpublication.start_time,
            end_time: this.$page.props.recruitmentpublication.end_time,
            category_id: this.$page.props.recruitmentpublication.category,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.recruitmentpublications.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.recruitmentpublications.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.recruitmentpublications.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.recruitmentpublications.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <b-button-group class="btn-group-sm mt-2">
                ...
                <inertia-link class="btn btn-secondary" :href="route('canvas.recruitmentpublications.index')" method="get">
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.recruitmentpublications.settranslation', $page.props.recruitmentpublication.id))">
              <slot />
            ...
            <b-form-group label="Requisitos" label-for="requirements">
                <b-form-textarea
                  id="requirements"
                  ...
                  max-rows="6"
                ></b-form-textarea>
                <div v-if="form.errors.requirements" class="invalid-feedback animated fadeIn">{{form.errors.requirements}}</div>
            </b-form-group>
