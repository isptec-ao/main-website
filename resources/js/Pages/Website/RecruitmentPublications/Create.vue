<script>
    ...
    export default {
        name: "CreateRecruitmentPublication",
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0 font-size-18">Recrutamento - Publicaçõess</h4>
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post('/canvas/recruitmentpublications')">
              <slot />
