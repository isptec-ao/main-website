    ...
    export default {
        ...
        data () {
          return {
            ...
            title: this.$page.props.contentsubmission.title,
            category: this.$page.props.contentsubmission.category,
            name: this.$page.props.contentsubmission.name,
            email: this.$page.props.contentsubmission.email,
            contact: this.$page.props.contentsubmission.contact,
            description_pt: this.$page.props.contentsubmission.description_pt,
            description_en: this.$page.props.contentsubmission.description_en,
            obs: this.$page.props.contentsubmission.obs,
            featured_image: null,
            imagepreview: null,
            documents: null,
        ...
        methods: {
            settranslation(id) {
              this.$inertia.put(this.route('canvas.contentsubmissions.settranslation', id));
          },
          imageSelected(e) {
          ...
          downloadAllAttachments () {
                window.open(route('canvas.contentsubmissions.downloadallattachments') + '?model_id=' + this.$page.post.id);
            },

            downloadSingleAttachment (id) {
                window.open(route('canvas.contentsubmissions.downloadsingleattachment') + '?model_id=' + id);
            },
            deleteSingleAttachment (id) {
                window.open(route('canvas.contentsubmissions.deletesingleattachment') + '?model_id=' + id);
            },  
        },
        computed: {
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-body">
            ...
            <b-form @submit.prevent="form.post(route('canvas.contentsubmissions.settranslation', $page.props.contentsubmission.id))">
              <slot />
